...
\begin{proof}
	...
	Now, we want to show that there exists a $\delta \in (0, R)$ such that the Taylor series of $f(x)$ at $x_0$ converges to $f(x)$ for every $x \in (x_0 - \delta, x_0 + \delta) \cap I$.
