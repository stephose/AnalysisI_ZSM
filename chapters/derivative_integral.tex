...
\begin{theorem}{A Criterion for Analyticity at $x_0$}{crit_analytic}
	Let $I \subseteq \mathbb{R}$ be an interval and $f:I \to \mathbb{R}$ a smooth function. Given $x_0 \in I$, assume that there exist constants $r, C_0, A > 0$ such that
	\[
...
\begin{proof}
	...
	Now, we want to show that there exists a $\delta \in (0, R)$ such that every Taylor series of $f(x)$ at $x_0$ converges to $f(x)$ for every $x \in (x_0 - \delta, x_0 + \delta) \cap I$.
