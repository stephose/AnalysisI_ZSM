...
If instead $x_0 \notin D$ but the limit in Equation \ref{eq:limit_neq_x} exists, we call the function $\tilde{f}$ defined in Equation \ref{eq:cont_ext} the \textbf{continuous extension} of $f$ to $D \cup \{x_0\}$.
